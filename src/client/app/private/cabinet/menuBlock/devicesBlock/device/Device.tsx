...
import { dateUntil, openModal, percentOfPackage, setColorBar } from '../../../../../../codebase/utils';
    ...
    return (
        activePackage ? (<div className="Device">
            ...
            <div className="device__right-block">
                <div className='device__active-arrow' onClick={() => STATE_API.setDeleteDevice(device.deviceId)}>   
