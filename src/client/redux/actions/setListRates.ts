...
import { setAuthenticatedCode } from "./setAuthenticated";

export const setListRatesCode = 'setListRates';

export const setListRatesAction = (rates : ListRatesResponse.SuccessModel.RateModel[]) => createAction(setAuthenticatedCode, rates);
