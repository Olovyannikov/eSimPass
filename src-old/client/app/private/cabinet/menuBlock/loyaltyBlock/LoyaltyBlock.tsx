        ...
        <div className="LoyaltyBlock">
            ...
            <div className="loyalty-block__qr-block_right">
                ...
                <div className="loyalty-block__text">
                    ...
                    <br/>
                    После пополнения баланса <span>промокод в виде QR-кода</span> появится слева. Его неоходимо будет просканировать через приложение eSIM Pass в разделе “Программа лояльности”.
                </div>
